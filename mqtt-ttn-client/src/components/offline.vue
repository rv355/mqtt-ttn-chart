<template>
    <div>
        <div class="row text-center">
            ...
            <div class="col-sm-3">
                <div class="filters">
                    <label for="basic-dropdown">Year: </label>
                    <select name="basic-dropdown" v-model="selectedYear">
                        <option>2020</option>
                        <option>2019</option>
                    </select>
                </div>
            ...
            <div class="col-sm-3">
                <div class="filters">
                    ...
                    <select name="basic-dropdown" v-model="selectedMonth">
                        <option>01</option>
                        <option>02</option>
                        <option>03</option>
                        <option>04</option>
            ...
            <div class="col-sm-3">
                <div class="filters">
                    <label for="basic-dropdown">Day: </label>
                ...
                <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3 col-lg-4 col-lg-offset-4">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">CO<sub>2</sub></h3>
                        </div>
                        ...
                        <div class="panel-footer">
                            <p v-if="displayedValues.length > 0">
                                <small>
                                    <span v-bind:style="{ color: dvColors.v1}">{{displayedValues[0].payload_fields.co2}} </span>
                                </small>
                            </p>
                        </div>
                    </div>
        ...
        <div class="text center">
            <span v-bind:style="{ color: dvColors.v1}">{{dataDirectory}} </span><br>
            <button v-on="offlineData">Update</button>
        </div>
    </div>
</template>
    ...
    export default {
        ...
        data() {
            return {
                ...
                offlineDirectory: "/home/rohit/Desktop/CDBB/scripts/ttn_data/mnt/tfc_data/tfc/csn_ttn/data_bin/",
                dataDirectory: "/home/rohit/Desktop/CDBB/scripts/ttn_data/mnt/tfc_data/tfc/csn_ttn/data_bin/2020/01/01",
                messageIndex: 0,
                selectedYear: "2020",
                selectedMonth: "01",
                selectedDay: "01",
        ...
        methods: {
            ...
            insertDatapoints(messages, chart) {
                for (let i = 0; i < messages.length; i++) {
                    let ttnData = {
                        Magnitude1: messages[i].payload_fields.co2
                    };
            ...
            offlineData: function(event) {
                this.dataDirectory = this.offlineDirectory + '/' + this.selectedYear
                alert(this.dataDirectory)
            }
        }
    }
